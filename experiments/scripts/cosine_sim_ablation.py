    ...
    for dataset_name in dataset_names:
        ...
        for cosine_sim in cosine_sims:
            ...
            model = StanceMining(
                ...
                cosine_similarity_threshold=cosine_sim,
        ...
        df.write_parquet(os.path.join('data', 'cosine_sim_ablation_results.parquet.zstd'), compression='zstd')
